...
namespace vCommands.EventArguments
{
    ...
    /// </summary>
    public class CommandMutationEventArgs
        : EventArgs
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="vCommands.EventArguments.CommandMutationEventArgs"/> class with the specified command name, old command value, and new command value.
        /// </summary>
        ...
        public CommandMutationEventArgs(string name, Command oldCommand, Command newCommand)
            : base()
        {
